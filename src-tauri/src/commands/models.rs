...
#[tauri::command]
pub async fn list_models(profile: String) -> Result<Vec<AiModel>, String> {
...
#[tauri::command]
pub async fn pull_model(profile: String, model_name: String) -> Result<String, String> {
...
/// Delete a model
#[tauri::command]
pub async fn delete_model(profile: String, model_name: String) -> Result<String, String> {
